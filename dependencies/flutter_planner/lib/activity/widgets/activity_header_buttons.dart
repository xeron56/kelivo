...
class ActivityHeaderButtons extends StatelessWidget {
  const ActivityHeaderButtons({Key? key, required this.isDialog})
    : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        IconButton(
          onPressed: () =>
              _onPressedLeadingIcon(context: context, isDialog: isDialog),
        ...
        PopupMenuButton<String>(
          onSelected: (value) =>
              _onSelectedMenuButton(context: context, value: value),
          itemBuilder: (context) => [
            PopupMenuItem(
              value: 'delete',
              child: Text(
