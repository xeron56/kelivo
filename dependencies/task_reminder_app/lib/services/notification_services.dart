...
// Request Permissions for Android
  ...
  Future<void> _configureLocalTimezone() async {
    ...
    // FlutterTimezone.getLocalTimezone() may return a String in older versions
    // or a TimezoneInfo object in newer versions. Handle both safely.
    ...
    if (tzResult is String) {
      ...
      timeZone = (dyn.name ?? dyn.timeZone ?? dyn.timezone ?? dyn.toString()).toString();
    }
