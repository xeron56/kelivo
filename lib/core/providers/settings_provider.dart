...
class SettingsProvider extends ChangeNotifier {
  ...
  Future<void> _load() async {
    ...
    if (_providerConfigs.isEmpty) {
      // Seed Groq as the only provider
      ensureProviderConfig('Groq', defaultName: 'Groq');
    }
...
enum ProviderKind { openai, google, claude, groq }
...
class ProviderConfig {
  ...
  static ProviderKind classify(String key, {ProviderKind? explicitType}) {
    ...
    if (k.contains('groq')) return ProviderKind.groq;
  ...
  static String _defaultBase(String key) {
    ...
    if (k.contains('groq')) return 'https://api.groq.com/openai/v1';
  ...
  static ProviderConfig defaultsFor(String key, {String? displayName}) {
    bool _defaultEnabled(String k) {
      ...
      if (s.contains('groq')) return true;
